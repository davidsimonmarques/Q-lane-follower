...
CONFIG = {
    ...
    "load_pretrained": True,  # Se True: carrega Q-table existente. Se False: começa do zero
    ...
    "speed_reward": 0.18,  # Recompensa máxima por velocidade
    "camera_width": 800,
    "camera_height": 400,
    "camera_fov": 90,
    "camera_x": 1.5,
    ...
    #Primeira rodada de treinamentos:
    # "action_map": {
        ...
        # 3: {"throttle": 0.5, "steer":  0.0, "brake": 0.0}, # Centro (Reto)
    ...
    "action_map": {
        ...
        2: {"throttle": 0.4, "steer": -0.1, "brake": 0.0}, # Esquerda Suave
        3: {"throttle": 0.5, "steer":  0.0, "brake": 0.0}, # Centro (Reto)
        4: {"throttle": 0.4, "steer":  0.1, "brake": 0.0}, # Direita Suave
